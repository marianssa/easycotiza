...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { descripcion: @plane.descripcion, meses: @plane.meses, nombre: @plane.nombre, precio: @plane.precio } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { descripcion: @plane.descripcion, meses: @plane.meses, nombre: @plane.nombre, precio: @plane.precio } }
