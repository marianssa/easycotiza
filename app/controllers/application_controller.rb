...
if resource_class == Client
	...
	devise_parameter_sanitizer.permit(:sign_up) { |u| u.permit(:nombre,:email, :password, :fecha_de_inicio, :telefono, :provincia, :rut, :password_confirmation,:imagen, :imagen_cache, :remove_imagen, :category_id, :descripcion, :plan_id) }
 	devise_parameter_sanitizer.permit(:account_update) { |u| u.permit(:nombre,:email, :password, :current_password, :fecha_de_inicio, :telefono, :provincia, :rut, :password_confirmation, :imagen, :imagen_cache, :remove_imagen, :descripcion, :category_id,:plan_id) }
end
end
end